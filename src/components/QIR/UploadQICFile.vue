  ...
  <div>
    ...
    <el-form :inline="true" :model="formInline" class="demo-form-inline" status-icon>
      ...
      <el-form-item label="RBO" prop="RBO">
        <el-input v-model="formInline.RBO" placeholder="RBO" clearable disabled />
      </el-form-item>
      <el-form-item label="Item" prop="item">
        <el-input v-model="formInline.internalItem" placeholder="Item" clearable @blur="blurR" />
      </el-form-item>
      <el-form-item label="batch" prop="batch">
        <el-input v-model="formInline.batch" placeholder="batch" clearable @blur="blurBatch" />
      </el-form-item>
      <el-form-item>
    ...
    <div class="qir-title qicm-title">
      <div><div>质量标准</div><div @click="()=>{_getImgByItem(formInline.internalItem);isReset = -1}" class="sb_hand">刷新</div></div>
    ...
    <div class="quality-box">
      ...
      <div class="box-right">
        <UploadImageHand2 _type="1" ref="Updata_IMG_Ref" :isReset="isReset" :rbo="formInline.RBO" :item="formInline.internalItem" />
      </div>
    </div>
    <!-- 投诉案例 -->
    <div class="qir-title qicm-title">
      <div><div>投诉案例</div><div @click="()=>{_getImgByItem(formInline.internalItem);isReset = -1}" class="sb_hand">刷新</div></div>
    ...
    <div class="complaint-box">
      ...
      <div class="box-right">
        <UploadImageHand2 _type="2" :isReset="isReset" :rbo="formInline.RBO" :item="formInline.internalItem" />
      </div>
    </div>
  </div>
