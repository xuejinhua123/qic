 ...
 * @returns 
 */
function _useOrderHooks (isShowRecordView:Ref<boolean>,_orderInfo:Ref<IQICOrderDByIP>, _record:Ref<IQICRecord>) {
  ...
  return {
    _filterSearchRecordList, _autoLoader, _batchLoader, _searchRecord, _getOrderByBatch
  }
}
