...
<template>
  ...
  <div class="jh_grid_100 pdf-box qirm-box scoll">
  ...
  <div class="qirm-box jh_grid_100 img-list scoll sb-h-108">
    <!-- <UploadImgList /> -->
    <div class="img-item" v-for="(v, i) in _qualityStandardList" :key="i">
      <el-image :preview-src-list="[v.path]" :src="v.path"
        ...
        style="width: 80px;" fit="contain" /><div class="img-title">{{v.remark}}</div></div>
      <!-- <UploadImg2 _type="1" /> -->
  </div>
  ...
  <div class="qirm-box scoll sb-h-90">
